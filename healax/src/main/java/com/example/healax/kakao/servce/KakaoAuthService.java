...
//        );
//
//        System.out.println("token response: " + tokenResponse.getBody().getAccess_token());
//
...
//        );
//
//        System.out.println("user info response Id: " + userInfoResponse.getBody().getId());
//        System.out.println("user info response email: " + userInfoResponse.getBody().getKakaoAccount().getEmail());
//        System.out.println("user info response nickname: " + userInfoResponse.getBody().getProperties().getNickname());
//
