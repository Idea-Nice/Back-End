package com.example.healax.security.provider;
...
public class RestAuthenticationProvider implements AuthenticationProvider {
    ...
    * 객체에는 사용자의 신원 정보와 인증된 자격 증명 포함 */
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!passwordEncoder.matches(userPw, userContext.getPassword())) {
    ...
    /*
    * false 값이 뜨면 여기있는 Provider 실행이 되지 않음
    * authentication 형식이 RestAuthentication 클래스 하고 같은지 확인 */
    @Override
